...
search_web = FunctionTool.from_defaults(
    ...
    description=(
        ...
        "This tool enables the SearchAgent to gather external context that cannot be derived "
        "from local project files alone. It is especially useful for enriching README content "
        "with:\n"
        "  - High-level explanations of frameworks, libraries, or protocols used in the project\n"
        "  - Best practices or common usage patterns for the technologies involved\n"
        "  - Concise summaries of how these technologies are generally applied\n\n"
